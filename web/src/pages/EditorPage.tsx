...
function EditorPage() {
    ...
    const { title, isDocJoined, isTitleSyncing } = useSyncEditorChanges(yDoc, isValidDocumentId ? documentId : -1);
    usePing();
    ...
    return (
        ...
        <div className="flex flex-col h-screen bg-[#1f1f1f] gap-2">
            ...
            <div className="flex-1 overflow-auto flex flex-col">
                <DocumentTitle documentId={documentId} title={title} isDocJoined={isDocJoined} isTitleSyncing={isTitleSyncing} />
