...
const OwnerTab = ({
    ...
    const isOwner = documentAccess === "owner"; // only the owner may transfer ownership
    ...
    return (
        <>
            ...
            {/* Transfer ownership search — only the owner can initiate a transfer */}
            {isOwner && (
                <>
                    <input
                        type="email"
                    ...
                    {!isFindLoading &&
                        ...
                        email.trim().length > 0 && (
                            <div
                                ...
                                rounded-lg text-xs mt-3 sm:mt-4"
                            >
                                Enter the exact email address of the person you
