...
/**
 * Confirmation dialog shown before workspace ownership is transferred. Closes
 * on Escape or backdrop click, both of which call onCancel. Sits above
 * WorkspaceConfigModal via z-[60].
 */
const TransferOwnerConfirmationModal = ({
    ...
    return (
        // Backdrop — click outside to cancel; z-[60] sits above WorkspaceConfigModal's z-50
        <div
