...
const TABS: { key: "overview" | "manage-access" | "default-access" | "owner"; label: string }[] = [
...
const useManageDocumentModal = ({
    ...
    const [selectedTab, setSelectedTab] = useState<"overview" | "manage-access" | "default-access" | "owner">("overview"); // currently active sidebar tab
